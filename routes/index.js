...
var env = {
  ...
  AUTH0_CALLBACK_URL: 'https://bluelotus-2-abarc.c9users.io/callback'
};
...
router.get('/workArea', ensureLoggedIn, function(req, res, next) {
  res.render('workArea', { user: req.user });
});

router.get('/workArea',
  function(req, res){
    res.render('workArea', { env: env });
  });
